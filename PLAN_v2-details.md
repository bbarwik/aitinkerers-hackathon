I now have a complete picture of the current codebase state (with all recent modifications) and all three cross-review documents. Here is the final unified implementation plan.
